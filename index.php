...
<div class="col-md-3">
<a href="#" class="pull-right btn sub1" style="border-radius:0%; font-size: 17px;" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>User<br/>Login</b></span></a></div>
<div class="col-md-3">
<a href="#" class="pull-right btn sub1" style="border-radius:0%; font-size: 17px;" data-toggle="modal" data-target="#login"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Admin <br/>Login</b></span></a></div>
<!--sign in modal start-->
...
<div class="form-group">
<input type="text" name="uname" maxlength="50"  placeholder="Admin Email" class="form-control"/> 
</div>
<div class="form-group">
